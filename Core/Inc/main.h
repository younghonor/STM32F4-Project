...
/* Private defines -----------------------------------------------------------*/
#define MTS_GPIO1_Pin GPIO_PIN_3
#define MTS_GPIO1_GPIO_Port GPIOE
#define MTS_GPIO3_Pin GPIO_PIN_2
#define MTS_GPIO3_GPIO_Port GPIOE
#define MTS_GPIO5_Pin GPIO_PIN_1
#define MTS_GPIO5_GPIO_Port GPIOE
#define MTS_GPIO7_Pin GPIO_PIN_0
#define MTS_GPIO7_GPIO_Port GPIOE
#define MTS_IO_DIR2_Pin GPIO_PIN_8
#define MTS_IO_DIR2_GPIO_Port GPIOB
#define MTS_LEAK_TEST_SEL2_Pin GPIO_PIN_14
#define MTS_LEAK_TEST_SEL2_GPIO_Port GPIOG
#define MTS_LEAK_TEST_1_Pin GPIO_PIN_13
#define MTS_LEAK_TEST_1_GPIO_Port GPIOG
#define MTS_SPI1_MISO_Pin GPIO_PIN_4
...
#define MTS_GPIO4_Pin GPIO_PIN_6
#define MTS_GPIO4_GPIO_Port GPIOE
#define MTS_GPIO6_Pin GPIO_PIN_9
#define MTS_GPIO6_GPIO_Port GPIOB
#define MTS_BID0_Pin GPIO_PIN_15
#define MTS_BID0_GPIO_Port GPIOG
#define MTS_BID1_Pin GPIO_PIN_12
#define MTS_BID1_GPIO_Port GPIOG
#define MTS_BID2_Pin GPIO_PIN_11
#define MTS_BID2_GPIO_Port GPIOG
#define MTS_IO_DIR4_Pin GPIO_PIN_10
#define MTS_IO_DIR4_GPIO_Port GPIOG
#define MTS_USART3_RX_Pin GPIO_PIN_11
#define MTS_USART3_RX_GPIO_Port GPIOC
#define MTS_USART3_TX_Pin GPIO_PIN_10
#define MTS_USART3_TX_GPIO_Port GPIOC
#define MTS_TIM8_CH3_Pin GPIO_PIN_7
#define MTS_TIM8_CH3_GPIO_Port GPIOI
#define MTS_TIM8_CH2_Pin GPIO_PIN_6
#define MTS_TIM8_CH2_GPIO_Port GPIOI
#define MTS_TIM8_CH1_Pin GPIO_PIN_5
...
#define MTS_IO_DIR0_Pin GPIO_PIN_8
#define MTS_IO_DIR0_GPIO_Port GPIOI
#define MTS_IO_DIR1_Pin GPIO_PIN_9
#define MTS_IO_DIR1_GPIO_Port GPIOI
#define MTS_IO_DIR3_Pin GPIO_PIN_4
#define MTS_IO_DIR3_GPIO_Port GPIOI
#define MTS_IO_EN_Pin GPIO_PIN_4
#define MTS_IO_EN_GPIO_Port GPIOD
#define MTS_LPC_nRST_Pin GPIO_PIN_15
#define MTS_LPC_nRST_GPIO_Port GPIOH
#define MTS_SPI2_CLK_Pin GPIO_PIN_1
#define MTS_SPI2_CLK_GPIO_Port GPIOI
#define MTS_TIM1_CH3_Pin GPIO_PIN_10
#define MTS_TIM1_CH3_GPIO_Port GPIOA
#define MTS_HID1_Pin GPIO_PIN_14
#define MTS_HID1_GPIO_Port GPIOC
#define MTS_I2C2_SDA_Pin GPIO_PIN_0
#define MTS_I2C2_SDA_GPIO_Port GPIOF
#define MTS_IO_VCCB_DVDD_Pin GPIO_PIN_10
#define MTS_IO_VCCB_DVDD_GPIO_Port GPIOI
#define MTS_LED_R_Pin GPIO_PIN_13
...
#define MTS_I2C3_SCL_Pin GPIO_PIN_8
#define MTS_I2C3_SCL_GPIO_Port GPIOA
#define MTS_RST_USB_HS_PHY_Pin GPIO_PIN_3
#define MTS_RST_USB_HS_PHY_GPIO_Port GPIOH
#define MTS_DUT_RST_EN_Pin GPIO_PIN_8
#define MTS_DUT_RST_EN_GPIO_Port GPIOC
#define MTS_VPP_OUT_Pin GPIO_PIN_2
#define MTS_VPP_OUT_GPIO_Port GPIOF
#define MTS_I2C2_SCL_Pin GPIO_PIN_1
...
#define MTS_DUT_SPI_SO_DIR_Pin GPIO_PIN_4
...
#define MTS_SHIFTER1_VCCB_SW_Pin GPIO_PIN_15
...
#define MTS_VDDIO_I_SEL_1_Pin GPIO_PIN_8
#define MTS_VDDIO_I_SEL_1_GPIO_Port GPIOH
#define MTS_VDDIIO_I_READ_3_Pin GPIO_PIN_9
#define MTS_VDDIIO_I_READ_3_GPIO_Port GPIOH
#define MTS_DAC_BSY_Pin GPIO_PIN_14
...
#define MTS_VDDIO_SW_Pin GPIO_PIN_13
#define MTS_VDDIO_SW_GPIO_Port GPIOE
#define MTS_DUT_SPI_EN__Pin GPIO_PIN_7
#define MTS_DUT_SPI_EN__GPIO_Port GPIOH
#define MTS_I2C_EN_Pin GPIO_PIN_12
...
#define MTS_AVDD_I_SEL_1E8_Pin GPIO_PIN_8
#define MTS_AVDD_I_SEL_1E8_GPIO_Port GPIOE
#define MTS_TIM1_CH1_Pin GPIO_PIN_9
#define MTS_TIM1_CH1_GPIO_Port GPIOE
#define MTS_TIM1_CH2_Pin GPIO_PIN_11
#define MTS_TIM1_CH2_GPIO_Port GPIOE
#define MTS_TIM1_CH4_Pin GPIO_PIN_14
#define MTS_TIM1_CH4_GPIO_Port GPIOE
#define MTS_DVDD_I_READ_1_2_Pin GPIO_PIN_9
#define MTS_DVDD_I_READ_1_2_GPIO_Port GPIOD
#define MTS_REV_IO_1_Pin GPIO_PIN_8
#define MTS_REV_IO_1_GPIO_Port GPIOD
#define MTS_SPI1_MOSI_Pin GPIO_PIN_7
#define MTS_SPI1_MOSI_GPIO_Port GPIOA
#define MTS_AVDD_SW_Pin GPIO_PIN_11
#define MTS_AVDD_SW_GPIO_Port GPIOF
#define MTS_AVDD_I_READ_3_Pin GPIO_PIN_14
#define MTS_AVDD_I_READ_3_GPIO_Port GPIOF
#define MTS_DVDD_I_READ_3_Pin GPIO_PIN_7
#define MTS_DVDD_I_READ_3_GPIO_Port GPIOE
#define MTS_DVDD_I_SEL_2_Pin GPIO_PIN_10
#define MTS_DVDD_I_SEL_2_GPIO_Port GPIOE
#define MTS_VEN_ID_0_Pin GPIO_PIN_12
#define MTS_VEN_ID_0_GPIO_Port GPIOE
#define MTS_VEN_ID_1_Pin GPIO_PIN_15
